          ...
          <div className="relative p-6 sm:p-8">
            <div className="premium-card rounded-2xl border border-white/10 bg-white/[0.045] p-5">
              <div className="flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-brand-300/20 bg-brand-300/10">
                  <Workflow className="h-7 w-7 text-brand-200" />
                </div>
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-200">Work With Us</p>
      ...
      <section id="openings" className="relative border-y border-white/8 bg-[#07101a] py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-brand-300">Role Areas</p>
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            {roleFamilies.map((role, index) => (
              <motion.article
                ...
                className="premium-card group rounded-2xl border border-white/8 bg-white/[0.035] p-6 transition hover:-translate-y-1 hover:border-brand-300/25 hover:bg-white/[0.055]"
              >
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {role.skills.map((skill) => (
                    <span key={skill} className="premium-card rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs font-medium text-slate-300 transition hover:-translate-y-0.5 hover:border-brand-300/20">
                      {skill}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-brand-300">Life At GENAIXIS</p>
            <h2 className="mt-4 text-3xl font-bold leading-tight text-white sm:text-5xl">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {benefits.map((benefit, index) => (
              ...
              >
                <benefit.icon className="h-6 w-6 text-brand-300" />
            ...
            {process.map((step, index) => (
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-brand-300/20 bg-brand-300/10">
